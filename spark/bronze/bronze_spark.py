...
from utils import BRONZE_DELTA_PATH, BRONZE_CHECKPOINT_PATH

"""
As we are going with medillion architecture in this project so each file represents a model ,
this one as you can precieve from the name is depecting Bronze Model.

We would just be reading from kafka and writing to delta
...
def main():
    # spark session
    spark = (
        SparkSession.builder.appName("BronzeSparkPipeline")
